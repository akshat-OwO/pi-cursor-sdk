...
function buildToolDisplayContext(
	toolCall: unknown,
...
export function formatCursorToolTranscript(
	toolCall: unknown,
	options: TranscriptOptions = {},
): string {
...
export function buildCursorPiToolDisplay(
	toolCall: unknown,
	options: TranscriptOptions = {},
): CursorPiToolDisplay {
...
export function mergeCursorToolCalls(
	startedToolCall: unknown,
	completedToolCall: unknown,
): unknown {
