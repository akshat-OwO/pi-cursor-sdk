...
import { computeCursorContextFingerprint } from "../context/context.js";
...
export { shouldBootstrapCursorSend } from "../context/context.js";
...
export async function disposeAllSessionCursorAgents(): Promise<void> {
	...
	await Promise.all(
		scopeKeys.map((scopeKey) => disposePoolEntryForScope(scopeKey, { terminal: true })),
	);
