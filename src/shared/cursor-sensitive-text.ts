import type { CursorPiToolDisplay } from "../transcript/cursor-transcript-utils.js";
...
function scrubDisplayValue(value: unknown, apiKey?: string): unknown {
	...
	if (value && typeof value === "object") {
		return Object.fromEntries(
			Object.entries(value).map(([key, entry]) => [key, scrubDisplayValue(entry, apiKey)]),
		);
	}
	return value;
}

export function scrubPiToolDisplay(
