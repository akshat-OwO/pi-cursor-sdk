...
import type { CursorNativeToolDisplayItem } from "../replay/cursor-native-tool-display.js";
import type {
	CursorPiBridgeToolRequest,
	CursorPiToolBridgeRun,
} from "../bridge/cursor-pi-tool-bridge.js";
import { getCursorSessionScopeKey } from "../session/cursor-session-scope.js";
...
export interface CursorLiveRunCoordinator {
	...
	getPendingFromContext(
		context: Context,
		getReplayId: CursorReplayIdResolver,
	): CursorLiveRun | undefined;
...
export function createCursorLiveRunCoordinator(
	deps: CursorLiveRunCoordinatorDeps,
): CursorLiveRunCoordinator {
